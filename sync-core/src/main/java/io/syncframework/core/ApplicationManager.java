...
public class ApplicationManager {
	...
	public static void register(Application application) {
		...
		if (log.isDebugEnabled()) {
			log.debug("{} registered", application);
		}
	}
	...
	public static Application getApplication(String domain) {
		...
		//
		// In case of just one application per server, then return this application to
		// handle the request.
		...
		//
		// For multiples applications under the server, then identify the correct
