 ...
 * is used at runtime. In the initialization time SyncFramework will optimize \@Controller classes and save them to
...
public interface OController {
	...
	/**
	 * \@Controller's Session Manager
	 */
	public SessionManager _asSession();
	/**
